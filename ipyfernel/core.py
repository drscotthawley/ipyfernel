...
# %% auto 0
__all__ = ['gip', 'set_ssh_config', 'register_remote_kernel', 'ipf_startup', 'ipf_exec', 'ipf_shutdown', 'start_remote',
           'stop_remote', 'remote', 'local', 'set_sticky', 'unset_sticky']
...
def set_ssh_config(
    ...
    "sets up user's ssh .config file with info used later"
...
def register_remote_kernel(
    ...
    "registers remote python kernel"
